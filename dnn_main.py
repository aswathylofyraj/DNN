...
# Convert the input row to a NumPy array and reshape it to match the model's expected input shape
row = np.array([9.1, 7.4, 5.4, 6.2])
row = row.reshape(1, -1)  # Reshape to match the input shape of the model
